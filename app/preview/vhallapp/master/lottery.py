...
class Lottery(PreviewRequest):
    def importTemplate(self, data):
        ...
        return self.get("v2/lottery/import-template", data)
    ...
    def importUser(self, data, filePath):
        ...
        return self.upload("v2/lottery/import-user", "lottery_users", filePath, data)

    def lotteryCount(self, data):
        requestUtil.openDocHook("控制台-抽奖-获取可抽奖人数 v2.0", self.dbUtil, ["room_lottery", "lottery_user"], False)
